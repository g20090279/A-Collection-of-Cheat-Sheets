...
# This file is to replace the norm mathjax delimiters with Github favoured delimiters in a markdown file, more precisely replace "$...$" to "$`...`$" and replace "$$...$$" with the code block
# ```math
# ...
# ```
